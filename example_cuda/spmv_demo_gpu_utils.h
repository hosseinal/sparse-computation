...
public:
  SpMVcuBlas(TensorInputsFloat *In1, swiftware::benchmark::Stats *Stat1)
    ...
    float *NA = static_cast<float *>(
        aligned_alloc(32, sizeof(float) * In1->ACsr->m * In1->ACsr->n));
    generateDenseFromCsr(In1->ACsr->m, In1->ACsr->n, In1->ACsr, NA);

    float *Trans_NA = static_cast<float *>(
        aligned_alloc(32, sizeof(float) * In1->ACsr->m * In1->ACsr->n));
...
public:
  SpMVComplexKernelV2(TensorInputsFloat *In1,
...
__device__ void PatternWith1NNZByRowPanelFull(int *RPP, int *NPP, float *NNZ,
  ...
  rowEnd = warp_id == number_of_warps - 1 && rowEnd < rowEnd_all ? rowEnd_all
                                                                 : rowEnd;
...
__global__ void SpmvComplexPatternDecomposeByRowSeperated(
  ...
  switch (i) {
  case 0:
    PatternWith4NNZByRowPanelFull(mf->cf[0]->RPP, mf->cf[0]->NPP,
                                  mf->cf[0]->NNZ, mf->cf[0]->CB, dX, dY, j, 0,
                                  1, 2, 3);
    break;
  case 1:
    PatternWith3NNZByRowPanelFull(mf->cf[1]->RPP, mf->cf[1]->NPP,
                                  mf->cf[1]->NNZ, mf->cf[1]->CB, dX, dY, j, 0,
                                  1, 2);
    break;
  case 2:
    PatternWith3NNZByRowPanelFull(mf->cf[2]->RPP, mf->cf[2]->NPP,
                                  mf->cf[2]->NNZ, mf->cf[2]->CB, dX, dY, j, 0,
                                  1, 3);
    break;
  case 3:
    PatternWith2NNZByRowPanelFull(mf->cf[3]->RPP, mf->cf[3]->NPP,
                                  mf->cf[3]->NNZ, mf->cf[3]->CB, dX, dY, j, 0,
                                  1);
    break;
  case 4:
    PatternWith3NNZByRowPanelFull(mf->cf[4]->RPP, mf->cf[4]->NPP,
                                  mf->cf[4]->NNZ, mf->cf[4]->CB, dX, dY, j, 0,
                                  2, 3);
    break;
  case 5:
    PatternWith2NNZByRowPanelFull(mf->cf[5]->RPP, mf->cf[5]->NPP,
                                  mf->cf[5]->NNZ, mf->cf[5]->CB, dX, dY, j, 0,
                                  2);
    break;
  case 6:
    PatternWith2NNZByRowPanelFull(mf->cf[6]->RPP, mf->cf[6]->NPP,
                                  mf->cf[6]->NNZ, mf->cf[6]->CB, dX, dY, j, 0,
                                  3);
    break;
  case 7:
    PatternWith1NNZByRowPanelFull(mf->cf[7]->RPP, mf->cf[7]->NPP,
                                  mf->cf[7]->NNZ, mf->cf[7]->CB, dX, dY, j, 0);
    break;
  case 8:
    PatternWith3NNZByRowPanelFull(mf->cf[8]->RPP, mf->cf[8]->NPP,
                                  mf->cf[8]->NNZ, mf->cf[8]->CB, dX, dY, j, 1,
                                  2, 3);
    break;
  case 9:
    PatternWith2NNZByRowPanelFull(mf->cf[9]->RPP, mf->cf[9]->NPP,
                                  mf->cf[9]->NNZ, mf->cf[9]->CB, dX, dY, j, 1,
                                  2);
    break;
  case 10:
    PatternWith2NNZByRowPanelFull(mf->cf[10]->RPP, mf->cf[10]->NPP,
                                  mf->cf[10]->NNZ, mf->cf[10]->CB, dX, dY, j, 1,
                                  3);
    break;
  case 11:
    PatternWith1NNZByRowPanelFull(mf->cf[11]->RPP, mf->cf[11]->NPP,
                                  mf->cf[11]->NNZ, mf->cf[11]->CB, dX, dY, j,
                                  1);
    break;
  case 12:
    PatternWith2NNZByRowPanelFull(mf->cf[12]->RPP, mf->cf[12]->NPP,
                                  mf->cf[12]->NNZ, mf->cf[12]->CB, dX, dY, j, 2,
                                  3);
    break;
  case 13:
    PatternWith1NNZByRowPanelFull(mf->cf[13]->RPP, mf->cf[13]->NPP,
                                  mf->cf[13]->NNZ, mf->cf[13]->CB, dX, dY, j,
                                  2);
    break;
  case 14:
    PatternWith1NNZByRowPanelFull(mf->cf[14]->RPP, mf->cf[14]->NPP,
                                  mf->cf[14]->NNZ, mf->cf[14]->CB, dX, dY, j,
                                  3);
    break;
  }
}
...
protected:
  ...
  bool verify(double &Error) override {
    ...
    for (int i = 0; i < InTensor->M - 4; ++i) {
      std::cout << OutTensor->Dx[i] << " " << InTensor->CorrectMul[i] << "\n";
      if (std::abs(OutTensor->Dx[i] - InTensor->CorrectMul[i]) > infNorm) {
        infNorm = std::abs(OutTensor->Dx[i] - InTensor->CorrectMul[i]);
      }
    }
  ...
  swiftware::benchmark::Timer execute() override {
    ...
    SpmvComplexPatternDecomposeByRowSeperated<<<
        (InT->MixedFormat->cf[0]->nrpp - 1) * 15, 128>>>(mf, dX, dY);
